...
* |--------+------+------+------+------+-------------|    |------+------+------+------+------+------+--------|
* | Tab    |   Q  |   W  |   E  |   R  |   T  | L1   |    |  L2  |   Y  |   U  |   I  |   O  |  P   | DEL    |
* |--------+------+------+------+------+------|      |    |      |------+------+------+------+------+--------|
* | LCtrl  |   A  |   S  |   D  |   F  |   G  |------|    |------|   H  |   J  |   K  |   L  |  ;   | Ent    |
* |--------+------+------+------+------+------| EI   |    | Kana |------+------+------+------+------+--------|
* | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |    |      |   N  |   M  |   ,  |   .  |  /   | RShift |
* `--------+------+------+------+------+-------------'    `-------------+------+------+------+------+--------'
*   |  F4  |  =   |  '"  | EI   | LCmd |                                | Kana | Left | Down |  Up  | Right  |
*   `----------------------------------'                                 `----------------------------------'
*                                        ,-------------. ,--------------.
*                                        | Prev | Next | | Up    | Right |
*                                 ,------|------|------| |-------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_F4,     KC_EQL,       KC_QUOT, LCTL(RSFT(KC_SCLN)), KC_LGUI,
                                              KC_MPRV,  KC_MNXT,
                                                                 KC_HOME,
                                              KC_SPC,   KC_BSPC, KC_END,
        // right hand
        KC_6,       KC_7, KC_8,    KC_9,    KC_0,    KC_MINS, KC_AT,
 ...
 * |        |      |      | MsUp |      |      |      |  |      | PgUp |MsWHUp| UP   |      |      |        |
 * |--------+------+------+------+------+------|      |  |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|      |MsRght|      |------|  |------| LEFT | DOWN | UP   |RIGHT |      |        |
 * |--------+------+------+------+------+------|      |  |      |------+------+------+------+------+--------|
 * |        |      |      |MsDown|      |      |      |  |      | PgDn |MsWHDn| DOWN |      |      |        |
 * `--------+------+------+------+------+-------------'  `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                               |VolUp |VolDn | Mute |      |      |
 *   `----------------------------------'                               `----------------------------------'
 *                                        ,-------------. ,-------------.
...
KEYMAP(
    ...
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_PGUP, KC_MS_WH_UP, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS,
                 KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_PGDN, KC_MS_WH_DOWN, KC_DOWN, KC_TRNS, KC_TRNS, KC_TRNS,
                          KC_VOLU, KC_VOLD, KC_MUTE, KC_TRNS, KC_TRNS,
       KC_UP, KC_RGHT,
       KC_LEFT,
       KC_DOWN, KC_BTN2, KC_BTN1
),
};
